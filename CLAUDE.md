...
- `README.md` is the agent technical reference. Update it per its own DOCUMENTATION GUIDELINES section whenever a stage, folder, schema, or config file changes.
